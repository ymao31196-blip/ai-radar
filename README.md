...
追踪最新的 AI 动态，**核心准则是：只看能落地的**。每一条记录都必须回答「这对我有什么用」，并补一段「通俗解释」，避免只堆术语和缩写。
...
| 🔬 科学计算 AI | [sciml/](sciml/) | 时序/SciML、气象AI、PINN、UQ、科研MLOps |
...
### 通俗解释
用不懂这个领域的人也能看懂的话解释：它像什么、解决什么问题、为什么值得关注。必须展开关键缩写/术语，尽量给一个类比或实际场景。
...
- **搞科研时**：翻 `sciml/`，看气象AI、时序模型、PINN 等方向的最新积累
