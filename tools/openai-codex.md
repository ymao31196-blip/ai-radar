...
#### 通俗解释
0.139.0 主要是让 Codex 更适合真实开发环境：需要查资料时不用离开工作流，接复杂 MCP 工具时不容易因为 schema 结构丢失而坏掉，排障信息也更完整。它不像一次大改版，更像把“能用”打磨成“更顺手、更好诊断”。
...
#### 通俗解释
alpha.8 是预览版，不是给生产环境稳稳升级用的版本。它更像“提前试看下一版可能怎么变”的测试包：适合单独开环境验证，不适合直接替换日常主力 Codex。
...
#### 通俗解释
这条的核心是 Codex 开始把“本地帮你改代码”扩展到“帮你临时开一台云机器再进去干活”。DigitalOcean Droplet 可以理解为一台云端小服务器，Codex 能自动创建和连接它，适合需要干净 Linux 环境或远程算力的开发任务。
